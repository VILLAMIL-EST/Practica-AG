...
Esta actividad utiliza un algoritmo genético para formar un equipo de desarrollo a partir de 12 candidatos. Cada candidato tiene una puntuación de habilidad técnica y está representado por una posición dentro de un cromosoma binario. Un bit con valor `1` indica que la persona fue seleccionada y un bit con valor `0` indica que no fue seleccionada.
